...
{
    /**
     * Return the global allowed-device snapshot to one machine-managed node.
     * The reporting count is intentionally separate from this whitelist.
     */
    public function devices(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'users' => (new DeviceStateService())->getUsersDevices($ids),
        ]);
    }
