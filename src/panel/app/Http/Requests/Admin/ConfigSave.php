...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'subscribe_path' => '',
        'subscribe_guard_enable' => 'boolean',
        'subscribe_guard_window_hours' => 'integer|min:1|max:720',
        'subscribe_guard_max_ips' => 'integer|min:1|max:255',
        'subscribe_guard_action' => 'in:reject,log_only',
        'upstream_subscribe_enable' => 'boolean',
        'upstream_subscribe_url' => 'nullable|string|max:2048',
        'upstream_subscribe_profiles' => 'nullable|array|max:20',
        'upstream_subscribe_profiles.*.id' => 'nullable|string|max:80',
        'upstream_subscribe_profiles.*.name' => 'nullable|string|max:120',
        'upstream_subscribe_profiles.*.url' => 'required|string|max:2048',
        'upstream_subscribe_profiles.*.enabled' => 'nullable|boolean',
        'upstream_subscribe_merge_mode' => 'in:append,prepend,replace',
        'upstream_subscribe_timeout' => 'integer|min:1|max:30',
        'upstream_subscribe_max_bytes' => 'integer|min:1024|max:1048576',
        'upstream_subscribe_user_agent' => 'nullable|string|max:255',
        // server
        ...
        'admin_ip_whitelist_enable' => 'boolean',
        'admin_ip_whitelist_entries' => 'nullable',
        'admin_ip_whitelist_note' => 'nullable|string|max:500',
